...
# Apply centralized styles and hide navigation links
apply_common_styles()
st.markdown(hide_navigation_links(), unsafe_allow_html=True)

# Keep essential course tooltip functionality 
st.markdown("""
<script>
        ...
        buttons.forEach(button => {
            if (button.textContent.trim() === buttonText && buttonText.includes('...')) {
                ...
                tooltip.style.cssText = `
                    ...
                    border-radius: 8px; font-size: 12px; white-space: nowrap; z-index: 9999;
...
const observer = new MutationObserver(addCourseTooltips);
