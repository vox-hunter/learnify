...
def show_score_display(course_data):
    ...
    if total_questions > 0:
        ...
        ">
            <span>0</span>
            <span style="font-weight: 600; color: #667eea;">{answered_questions}/{total_questions} Answered</span>
...
def show_course_navigation(course_data, course_id=None):  # course_id kept for API compatibility
    ...
    <div style="margin-bottom: 1.5rem;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
            ...
            <span style="color: #667eea; font-weight: 600;">{current_section + 1}/{total_sections}</span>
        </div>
        <div style="
            width: 100%;
            height: 6px;
