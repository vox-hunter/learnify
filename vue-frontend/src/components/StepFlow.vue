<template>
    <div ref="stepFlowContainer" class="step-flow" tabindex="0" @keydown.enter="handleEnterKey">
        <!-- Progress Bar at Top -->
        ...
        <div v-if="answeredCount > 0" class="end-early-container">
                ...
                <div :key="currentStepIndex" class="step-content">
                    ...
                    <div v-else-if="currentStep.type === 'question'" class="question-step">
                        ...
                        <QuizQuestion :question="currentStep.question" :question-index="currentStep.questionIndex"
                            ...
                            :saved-answer-data="currentStep.savedAnswerData" @answer-submitted="handleAnswerSubmit" />
                    </div>
                </div>
            </transition>

            <!-- Navigation Controls -->
            <div v-if="canProceed" class="navigation-controls">
