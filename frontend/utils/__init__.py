...
from .common_styles import (
    apply_common_styles, get_base_styles, get_sidebar_styles, hide_navigation_links
)
...
from .navigation_cache import (
    record_page_visit, cache_course_list, get_cached_course_list,
    purge_stale_course_cache, warm_next_pages, remove_course_from_cache
)
